...
<link rel="canonical" href="/en/home.php" />
      ...
      <section id="sectionimage" contenteditable="true">
        <div class="swiper-container swiper-slider swiper-variant-1 bg-black swiper-container-horizontal" data-loop="false" data-autoplay="5500" data-swipe="true" data-simulate-touch="true">
          <div class="swiper-wrapper text-center" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
            <div class="swiper-slide swiper-slide-active" data-slide-bg="medias/image/site1/background_rough-horn.webp" style="background-image: url('medias/image/site1/background_rough-horn.webp'); background-size: cover; width: 1905px;">
            ...
            <div class="swiper-slide swiper-slide-next" data-slide-bg="medias/image/site1/background_sunset.webp" style="background-image: url('medias/image/site1/background_sunset.webp'); background-size: cover; width: 1905px;">
              <div class="swiper-slide-caption">
                <div class="container">
                  <div class="row justify-content-sm-center">
        ...
        <div class="row no-gutters justify-content-sm-center justify-content-md-start row-40 row-sm-0">
          <div class="col-sm-10 col-md-6 height-fill">
            <div class="icon-box icon-box-top-line icon-box-hover">
              <div class="box-top">
                <div class="box-icon"><img width="50px" src="medias/image/site1/briefcase.png"></div>
          ...
          <div class="col-sm-10 col-md-6 height-fill">
            <div class="icon-box icon-box-top-line icon-box-hover">
              <div class="box-top">
                <div class="box-icon"><img width="50px" src="medias/image/site1/package.png"></div>
                <div class="box-header">
          ...
          <div class="col-sm-10 col-md-6 height-fill">
            <div class="icon-box icon-box-hover">
              <div class="box-top">
                <div class="box-icon"><img width="50px" src="medias/image/site1/light-bulb.png"></div>
                <div class="box-header">
          ...
          <div class="col-sm-10 col-md-6 height-fill">
            <div class="icon-box icon-box-hover">
              <div class="box-top">
                <div class="box-icon"><img width="50px" src="medias/image/site1/organization.png"></div>
                <div class="box-header">
              ...
              <div class="owl-carousel owl-carousel-center owl-nav-modern owl-style-minimal owl-style-minimal-inverse text-center" data-items="1" data-md-items="2" data-xl-items="3" data-stage-padding="15" data-loop="false" data-margin="15" data-mouse-drag="false" data-nav="true" data-dots="true">
                <div class="owl-item text-center">
                  <div class="thumbnail-variant-5">
                    <div class="thumbnail-variant-5-img-wrap"><img class="img-circle" src="medias/image/site1/alberteinstein.jpg" width="129" height="129" alt=""></div>
                ...
                <div class="owl-item text-center">
                  <div class="thumbnail-variant-5">
                    <div class="thumbnail-variant-5-img-wrap"><img class="img-circle" src="medias/image/site1/pierrecurie.jpg" width="129" height="129" alt=""></div>
                    <h2>Pierre Curie</h2>
                    <div>CTO</div>
                    <div class="divider-fullwidth bg-porcelain"></div>
                    <div class="link-group"><span class="icon icon-xxs icon-primary fa fa-phone"></span><a class="link-black" href="callto:#">+555 123 456</a></div>
                ...
                <div class="owl-item text-center">
                  <div class="thumbnail-variant-5">
                    <div class="thumbnail-variant-5-img-wrap"><img class="img-circle" src="medias/image/site1/mariecurie.jpg" width="129" height="129" alt=""></div>
                    <h2>Marie Curie</h2>
                    <div>Bookkeeper</div>
                    <div class="divider-fullwidth bg-porcelain"></div>
                    <div class="link-group"><span class="icon icon-xxs icon-primary fa fa-phone"></span><a class="link-black" href="callto:#">+555 123 456</a></div>
                ...
                <div class="owl-item text-center">
                  <div class="thumbnail-variant-5">
                    <div class="thumbnail-variant-5-img-wrap"><img class="img-circle" src="medias/image/site1/daviddoe.png" width="129" height="129" alt=""></div>
                    <h2>John Doe</h2>
                  ...
                  <div class="inset-xl-right-50">
                    <div class="slick-slider slick-slider slick-carousel-round-image slick-images" id="child-carousel" data-for=".carousel-parent" data-arrows="false" data-loop="false"
                      ...
                      <div class="itemphotouser">
                        <div class="imp-wrap"><img class="photouser" src="medias/image/site1/alberteinstein.jpg" alt="" width="99" height="99"/>
                        </div>
                      </div>
                      <div class="itemphotouser">
                        <div class="imp-wrap"><img class="photouser" src="medias/image/site1/pierrecurie.jpg" alt="" width="99" height="99"/>
                        </div>
                      </div>
                      <div class="itemphotouser">
                        <div class="imp-wrap"><img class="photouser" src="medias/image/site1/mariecurie.jpg" alt="" width="99" height="99"/>
                        </div>
                      </div>
                      <div class="itemphotouser">
                        <div class="imp-wrap"><img class="photouser" src="medias/image/site1/daviddoe.png" alt="" width="99" height="99"/>
                        </div>
                      </div>
                    </div>
                  </div>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 11); dolWebsiteIncrementCounter(2, "page", 11);
// END PHP ?>
