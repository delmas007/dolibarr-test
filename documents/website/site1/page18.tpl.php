...
<meta name="dolibarr:pageid" content="18" />
<link rel="canonical" href="/en/service-s.php" />
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 18); dolWebsiteIncrementCounter(2, "page", 18);
// END PHP ?>
