...
<script nonce="6877397f" async src="/javascript.js.php?website=<?php echo $websitekey; ?>"></script>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 7); dolWebsiteIncrementCounter(2, "page", 7);
// END PHP ?>
