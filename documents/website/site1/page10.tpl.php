...
<meta name="dolibarr:pageid" content="10" />
<link rel="canonical" href="/header.php" />
...
<script nonce="852a6b8c" async src="/javascript.js.php?website=<?php echo $websitekey; ?>"></script>
...
<script src="/document.php?modulepart=medias&file=js/site1/extlib.min.js"></script>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 10); dolWebsiteIncrementCounter(2, "other", 10);
// END PHP ?>
