...
<meta name="dolibarr:pageid" content="12" />
<link rel="canonical" href="/en/our-team.php" />
      ...
      <section id="sectionimage" contenteditable="true">
        ...
        <section id="sectionteam" contenteditable="true" class="section-50 section-md-50 section-md-bottom-50">
            ...
            foreach($arrayofusers as $id)
            {
                ...
                else print '<img class="img-circle" src="/viewimage.php?modulepart=medias&amp;file=image/site1/daviddoe.png" width="129" height="129" alt="">';
                print '</div>';
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 12); dolWebsiteIncrementCounter(2, "page", 12);
// END PHP ?>
