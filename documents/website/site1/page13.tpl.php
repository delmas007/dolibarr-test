...
<meta name="dolibarr:pageid" content="13" />
<link rel="canonical" href="/en/partners.php" />
...
<div class="row justify-content-sm-center row-40">
    <div class="col-sm-8 col-md-2 col-lg-2">
        <div>
            <img src="/viewimage.php?modulepart=medias&file=image/site1/dolibarr_256x256.png" height="64px"><br>
            <div class="floatatbottom"><a href="https://www.dolibarr.org" target="_new">Dolibarr ERP CRM</a></div>
        </div>
    </div>
    <div class="col-sm-4 col-md-2 col-lg-2">
         <div>
        <img src="/viewimage.php?modulepart=medias&file=image/site1/php.png" height="64px"><br>
        <div class="floatatbottom"><a href="http://www.php.net" target="_new">PHP</a></div>
        </div>
    </div>
    <div class="col-sm-4 col-md-2 col-lg-2">
         <div>
        <img src="/viewimage.php?modulepart=medias&file=image/site1/apache.png" height="64px"><br>
        <div class="floatatbottom"><a href="https://www.apache.org" target="_new">Apache</a></div>
        </div>
    </div>
    <div class="col-sm-4 col-md-2 col-lg-2">
         <div>
        <img src="/viewimage.php?modulepart=medias&file=image/site1/mariadb.png" height="64px"><br>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 13); dolWebsiteIncrementCounter(2, "page", 13);
// END PHP ?>
