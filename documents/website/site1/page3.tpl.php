...
<meta name="dolibarr:pageid" content="3" />
<link rel="canonical" href="/en/blog-our-new-web-site-has-been-launched.php" />
...
<?php includeContainer('header'); ?>
      ...
      <section id="sectionimage" contenteditable="true">
        ...
        <div class="container">
            ...
            <figure>
            <img src="/viewimage.php?modulepart=medias&file=image/site1/background_rough-horn.webp">
            <br><br>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 3); dolWebsiteIncrementCounter(2, "blogpost", 3);
// END PHP ?>
