...
<meta name="dolibarr:pageid" content="16" />
<link rel="canonical" href="/en/product-p.php" />
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 16); dolWebsiteIncrementCounter(2, "page", 16);
// END PHP ?>
