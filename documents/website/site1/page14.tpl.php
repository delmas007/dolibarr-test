...
<meta name="dolibarr:pageid" content="14" />
<link rel="canonical" href="/en/pricing.php" />
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 14); dolWebsiteIncrementCounter(2, "page", 14);
// END PHP ?>
